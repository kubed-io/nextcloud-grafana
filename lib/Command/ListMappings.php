...
final class ListMappings extends Command {
	...
	protected function configure(): void {
		$this
			->setName('grafana_sync:list-mappings')
	...
	protected function execute(InputInterface $input, OutputInterface $output): int {
		...
		// "what is this mapping shared with" is the question anyone reading this list
		// is asking. They are read from the folder as this runs.
		$mappings = array_map(
