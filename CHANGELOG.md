...
- Admin **Sync Actions** panel now shows the full action set — **Sync to Grafana** / **Sync from Grafana** / **Purge Nextcloud files** — beside **Test connection**, matching the n8n app's layout. **Sync from Grafana** and Test connection work today; Sync to Grafana + Purge are disabled until the writeback release.
