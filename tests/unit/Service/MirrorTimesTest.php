 ...
 * mirrors, without giving back the churn that saga Ch2 Course 7 removed.
 *
 * Parsing Grafana's ISO-8601 strings is NOT here: those arrive already decoded on
 * {@see DashboardSpec}, which is where the client puts them, so there is exactly one
 * parser rather than the two the n8n master ended up with.
 *
